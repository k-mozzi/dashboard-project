    ...
    <ul class="dashboard__bar">
        ...
        <li id="profile" class="dashboard__bar__item">
            ...
            <div class="dashboard__submenu">
                <a href="../dashboard/dash_register.php">Sign-up</a>
                <a href="../dashboard/dash_login.php">Log-in</a>
            </div>
        </li>
...
<div id="real_dash">
    ...
    if (isset($_SESSION['userid'])) {
        ...
        <button onclick="location.href='logout_action.php'" style="float:right; font-size:1rem; cursor: pointer">로그아웃</button>
        <br/>
        <?php
    } else {
        ?>
    ...
    ?>
    <p style="font-size:1.5rem; text-align:center"><b>게시판</b></p>
    <table align=center>
        <thead align="center">
        <tr>
        ...
        while ($rows = mysqli_fetch_assoc($result)) { //result set에서 레코드(행)를 1개씩 리턴
            ...
            <td width="500" align="center">
                <a href="dash_read.php?number=<?php echo $rows['number'] ?>" style="text-decoration: none; color: black">
                    <?php echo $rows['title'] ?>
            </td>
    ...
    <div class=text>
        <font style="cursor: pointer" onClick="location.href='dash_write.php'"><b>글쓰기</b></font>
    </div>
</div>
</body>
